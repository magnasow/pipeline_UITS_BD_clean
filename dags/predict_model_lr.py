# ---------------------------------------------------------
# Prédiction 2026–2030 Linear Regression
...
# Dernières valeurs connues du pays
query = """
...
X_future["modele"] = "LinearRegression"
...
cursor.close()
conn.close()
print("[OK] Prédictions LR insérées pour 2026–2030")
